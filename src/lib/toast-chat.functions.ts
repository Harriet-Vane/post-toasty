...
export const chatToastBuilder = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<ToastChatResult> => {
    ...
    const system = [
      ...
      "- If the user gives positive feedback ('perfect', 'love it', 'yes', 'great'): celebrate briefly ('Yay!', 'Hooray!', 'Glad you like it!') and end with 'Anything else?'. Do NOT re-list ingredients.",
